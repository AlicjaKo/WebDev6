...
//current
    ...
    document.getElementById("current-icon").src = `./icons/${data.properties.timeseries[ind].data.next_1_hours.summary.symbol_code}.png`;
...
//1h
    document.getElementById("1h-img").src = `./icons/${data.properties.timeseries[ind+1].data.next_1_hours.summary.symbol_code}.png`;
    document.getElementById("1h-temp").innerText = data.properties.timeseries[ind+1].data.instant.details.air_temperature;

//2h
    document.getElementById("2h-img").src = `./icons/${data.properties.timeseries[ind+2].data.next_1_hours.summary.symbol_code}.png`;
    document.getElementById("2h-temp").innerText = data.properties.timeseries[ind+2].data.instant.details.air_temperature;

//3h
    document.getElementById("3h-img").src = `./icons/${data.properties.timeseries[ind+3].data.next_1_hours.summary.symbol_code}.png`;
